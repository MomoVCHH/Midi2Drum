		...
		chckbxGenerateWavWithoutDrums.setSelected(true);
				...
				buttonExport.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent arg0) {
						...
						String outputPath = new File("Editor").getAbsolutePath();
						...
						midiToITR.convertTrackToITR(outputPath + File.separator + "ITR" + File.separator + tf_songTitle.getText() + ".itr",
								...
								(int) comboBoxLevel.getSelectedItem(),(double) comboBoxVolume.getSelectedItem(), pictureFile, midiToITR.getNumTrackDrums(),
								1);
